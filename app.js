...
app.all('/paperui/*', restAuth, preassembleBody, setOpenhab, proxyRouteOpenhab);
app.all('/imperihome/*', restAuth, preassembleBody, setOpenhab, proxyRouteOpenhab);
app.all('/basicui/*', restAuth, preassembleBody, setOpenhab, proxyRouteOpenhab);
app.all('/rrd*', restAuth, preassembleBody, setOpenhab, proxyRouteOpenhab);
